<div class="flex justify-center my-6">
    <div class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 w-full max-w-lg">
        ...
        <div class="mb-6">
            ...
            <p><strong>Actividad:</strong> {{ $assist->activity ? 'Entrada' : 'Salida' }}</p>
            <p><strong>Fecha de Inicio:</strong> {{ $assist->start_date }}</p>
            @if ($assist->activity === 0 && $assist->end_date)
                <p><strong>Fecha de Fin:</strong> {{ $assist->end_date }}</p>
            @endif
