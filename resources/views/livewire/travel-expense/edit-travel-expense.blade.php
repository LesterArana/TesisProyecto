<div class="flex justify-center my-6">
    <form class="bg-white p-8 rounded-lg shadow-md space-y-5 w-full max-w-lg" wire:submit.prevent="update">
        <h2 class="text-2xl font-bold text-gray-900">Editar Gasto de Viaje</h2>
