<div class="flex justify-center my-12">
    <form class="justify-center bg-center md:w-1/2 space-y-5 p-9 bg-white rounded-lg shadow-md" wire:submit.prevent='update'>
        ...
        <div class="mb-6">
            <x-input-label for="type_person" :value="__('Tipo de Cliente')" />
        ...
        <div class="mb-6">
            ...
            <input type="checkbox" id="state" wire:model="state" class="form-checkbox h-6 w-6 text-green-500" value="1" {{ $state ? 'checked' : '' }}>
